...
for (let i = tweets.length; i < 20; i++) {
  tweets.push(new Tweet('Lorem ipsum dolor sit amet consectetur adipisicing elit. ' + i, i+'', new Date(Date.parse(new Date('2022-02-12T12:37')) + i * msPerMin), 'Kirill', [ new Comment('Wow!', i + '1', new Date(Date.parse(new Date('2022-02-12T13:37')) + i * msPerMin), 'NeKirill')]));
}
